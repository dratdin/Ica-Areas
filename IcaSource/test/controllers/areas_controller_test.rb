...
class AreasControllerTest < ActionController::TestCase
  ...
  test "should create area" do
    assert_difference('Area.count') do
      post :create, area: {  title: @area. title, description: @area.description, image_url: @area.image_url }
    end
  ...
  test "should update area" do
    patch :update, id: @area, area: {  title: @area. title, description: @area.description, image_url: @area.image_url }
    assert_redirected_to area_path(assigns(:area))
  end
